...
[`/react`](https://github.com/Gruven/text-mask/tree/master/react)
and Angular in [`/angular2`](https://github.com/Gruven/text-mask/tree/master/angular2).
Under the hood, these components are powered by the same **core**
[`/core`](https://github.com/Gruven/text-mask/tree/master/core).
...
[`createTextMaskInputElement`](https://github.com/Gruven/text-mask/blob/master/core/src/createTextMaskInputElement.js),
...
[`angular2/example`](https://github.com/Gruven/text-mask/tree/master/angular2/example), and
1. The webpack process will build the code in
[`angular2/src`](https://github.com/Gruven/text-mask/tree/master/angular2/src)
along with the code in
[`core/src`](https://github.com/Gruven/text-mask/tree/master/core/src).
...
the root [`package.json`](https://github.com/Gruven/text-mask/blob/master/package.json) to see the specific spellings.
